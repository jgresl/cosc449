...
<div id="column2">
    <article style="height:550px">
        ...
        <script>
            // Retrieve data
            var metricName = "Reading";
            var metricCount = <?php echo json_encode($temperature); ?>;
            var metricMonths = <?php echo json_encode($date_time); ?>;
            var optwidth = 720;
            var optheight = 370;
            ...
            dataset.forEach(function(d) {
                d.month = d3.time.format("%Y-%m-%d %H:%M:%S").parse(d.month);
            });
